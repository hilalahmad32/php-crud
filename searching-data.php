...
<div class="container">
    ...
    <div class="table-responsive">
        ...
        if (isset($_GET["search"])) {
            ...
            $limit = 3;
            $offset = ($page - 1) * $limit;
            $sql = "SELECT * FROM student WHERE username LIKE '%{$search}%' OR city LIKE '%{$search}%' ORDER BY id DESC LIMIT $offset,$limit";
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="./php/delete-data.php?id=<?php echo $row['id'] ?>" class="btn btn-danger">Delete</a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
        ...
        <?php }
                ...
                ?>
        <h1 class="danger">Data not found</h1>
        <?php
            }
            }
